        ...
        <div className={styles.container}>
          ...
          <section className={styles.textContainer}>
            ...
            2025年 3月 産業能率大学 情報マネジメント学部 現代マネジメント学科 通信教育課程 卒業見込
              ...
              音楽に関連するウェブサイト、ロゴ、フライヤーなどからインスピレーションを受け、<br />
              デザインの魅力に惹かれました。<br />
               音楽への愛着から、高校時代からライブハウスに足繁く通い、<br />
               今でも月に最大3回は足を運んでいます。 <br />
              デザインを学んで1年ほど経ちましたが、自身の思い描いた物を形にして喜んで頂いた時や、<br />
              かっこいい物が出来た時に達成感を感じています。<br />
            </p>
